...
export const PostsIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
...
export const MediaIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
...
export const DraftsIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
    <polyline points="14 2 14 8 20 8" />
...
export const TagsIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
...
export const RssIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
...
export const HnIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
    <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
    <path d="M8 8l4 5 4-5" />
    <path d="M12 13v4" />
...
export const CurationIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
...
export const DeployIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
...
export const ExternalIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
...
export const UnlockIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
    <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
...
export const FlameIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
    <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z" />
  </svg>
);

export const WorldIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
...
export const ArrowLeftIcon = ({ size = 20, ...props }: IconProps) => (
  <svg {...baseSvgProps(size)} {...props}>
